...
import {Honk, NUMBER_OF_ALPHAS, NUMBER_OF_ENTITIES, BATCHED_RELATION_PARTIAL_LENGTH, CONST_PROOF_SIZE_LOG_N} from "./HonkTypes.sol";
import {Fr, FrLib} from "./Fr.sol";
import {LOG_N, NUMBER_OF_PUBLIC_INPUTS} from "./keys/EcdsaHonkVerificationKey.sol";
...
library TranscriptLib {
    function generateTranscript(Honk.Proof memory proof, Honk.VerificationKey memory vk, bytes32[] calldata publicInputs)
        internal
        view
